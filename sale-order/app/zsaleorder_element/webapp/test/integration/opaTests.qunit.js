...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "zsaleorderelement/test/integration/FirstJourney",
    "zsaleorderelement/test/integration/OrdersListJourney",
    "zsaleorderelement/test/integration/OrdersObjectPageJourney",
    "zsaleorderelement/test/integration/OrderItemsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
